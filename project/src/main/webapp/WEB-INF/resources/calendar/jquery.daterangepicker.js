	...
	$.fn.dateRangePicker = function(opt)
	{
		...
		$(this).data('dateRangePicker',
		{
			...
			destroy: function()
			{
				...
				$(self).data('date_picker-opened',null);
				box.remove();
		...
		function init_datepicker()
		{
			...
			if ($(this).data('date_picker-opened'))
			{
				closeDatePicker();
				return;
			}
			$(this).data('date_picker-opened',true);


			box = createDom().hide();
			box.append('<div class="date_range-length-tip"></div>');
			box.delegate('.day', 'mouseleave', function()
			{
				box.find('.date_range-length-tip').hide();
			});
		...
		function clearSelection()
		{
			...
			opt.end = false;
			box.find('.day.checked').removeClass('checked');
			box.find('.day.last-date_selected').removeClass('last-date_selected');
			box.find('.day.first-date_selected').removeClass('first-date_selected');
		...
		function dayClicked(day)
		{
			...
			{
				$(self).trigger('datepicker-first-date_selected',
				{
					'date1' : new Date(opt.start)
				});
				dayHovering(day);
			...
			else
			{
				...
				if (opt.start && !opt.end)
				{
					...
					if (tooltip)
					{
						...
						var $tip = box.find('.daterange-length-tip');
		...
		function showSelectedDays()
		{
			...
			box.find('.day').each(function()
			{
				...
				//add first-date_selected class name to the first date selected
				if ( opt.start && moment(start).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD') )
				{
					$(this).addClass('first-date_selected');
				}
				else
				{
					$(this).removeClass('first-date_selected');
				}
				//add last-date_selected
				if ( opt.end && moment(end).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD') )
				{
					$(this).addClass('last-date_selected');
				}
				else
				{
					$(this).removeClass('last-date_selected');
				}
			});
		...
		function closeDatePicker()
		{
			...
			{
				$(self).data('date_picker-opened',false);
		...
		function createDom()
		{
			var html = '<div class="date_picker-wrapper';
